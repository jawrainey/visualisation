function scatterChart(daten, width, height, div)
{
    google.setOnLoadCallback( function()
    {
        ...
        for (item in rowData)
        {
            data.addRow([rowData[item][1], rowData[item][0]]);
        }
        //Initalise the chart, and draw it with our data, to the specified element.
        new google.visualization.ScatterChart(document.getElementById(div)).draw(data, {"width": width, "height": height});
    });
