function steppedAreaChart(daten, width, height, div)
{
    google.setOnLoadCallback( function()
    {
        ...
        new google.visualization.SteppedAreaChart(document.getElementById(div)).draw(data, {"width": width, "height": height});
    });
